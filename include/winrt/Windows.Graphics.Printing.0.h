...
struct PrintPageDescription {
	Foundation::Size PageSize;
	Foundation::Rect ImageableRect;
	unsigned DpiX;
	unsigned DpiY;
};
enum class PrintMediaSize : int {
	Default = 0,
	NotAvailable = 1,
	PrinterCustom = 2,
	BusinessCard = 3,
...
enum class PrintOrientation : int {
	Default = 0,
	NotAvailable = 1,
	PrinterCustom = 2,
	Portrait = 3,
...
enum class PrintTaskCompletion : int {
	Abandoned = 0,
	Canceled = 1,
	Failed = 2,
	Submitted = 3,
