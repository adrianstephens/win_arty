...
enum class NotificationSetting : int {
	Enabled = 0,
...
enum class BadgeTemplateType : int {
	BadgeGlyph = 0,
	BadgeNumber = 1,
};
enum class TileFlyoutTemplateType : int {
	TileFlyoutTemplate01 = 0,
};
enum class TileTemplateType : int {
	TileSquareImage = 0,
	TileSquareBlock = 1,
	TileSquareText01 = 2,
	TileSquareText02 = 3,
...
enum class ToastTemplateType : int {
...
enum class PeriodicUpdateRecurrence : int {
	HalfHour = 0,
	Hour = 1,
	SixHours = 2,
	TwelveHours = 3,
...
enum class ToastHistoryChangedType : int {
	Cleared = 0,
	Removed = 1,
	Expired = 2,
	Added = 3,
};
enum class AdaptiveNotificationContentKind : int {
	Text = 0,
};
enum class NotificationMirroring : int {
	Allowed = 0,
	Disabled = 1,
};
...
enum class UserNotificationChangedKind : int {
	Added = 0,
	Removed = 1,
};
enum class NotificationUpdateResult : int {
	Succeeded = 0,
	Failed = 1,
	NotificationNotFound = 2,
};
enum class ToastNotificationPriority : int {
	Default = 0,
	High = 1,
};
