...
enum class FormatEffect : int {
	Off = 0,
	On = 1,
	Toggle = 2,
	Undefined = 3,
};
enum class HorizontalCharacterAlignment : int {
	Left = 0,
	Right = 1,
	Center = 2,
};
...
enum class MarkerAlignment : int {
	Undefined = 0,
	Left = 1,
	Center = 2,
	Right = 3,
...
enum class VerticalCharacterAlignment : int {
	Top = 0,
	Baseline = 1,
	Bottom = 2,
};
