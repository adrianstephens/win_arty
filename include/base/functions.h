...
template<typename r, typename... pp> struct function<r(pp...)> { 
	enum	{ N = VT_count<pp...>::value };
	typedef r				R;
	typedef typelist<pp...> P;
	typedef R (F)(pp...);
#ifdef USE_STDCALL
...
template<typename r, typename... pp> struct function_p<r, typelist<pp...> > : function<r(pp...)>	{};
...
template<typename r> struct function<r(void)> { DEF(0, (void)); typedef typelist<> P; };
template<typename r, typename P1> struct function<r(P1)> { DEF(1, (P1)); typedef typelist<P1> P; };
template<typename r, typename P1, typename P2> struct function<r(P1,P2)> { DEF(2, (P1,P2)); typedef typelist<P1,P2> P; };
template<typename r, typename P1, typename P2, typename P3> struct function<r(P1,P2,P3)> { DEF(3, (P1,P2,P3)); typedef typelist<P1,P2,P3> P; };
template<typename r, typename P1, typename P2, typename P3, typename P4> struct function<r(P1,P2,P3,P4)> { DEF(4, (P1,P2,P3,P4)); typedef typelist<P1,P2,P3,P4> P; };
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5> struct function<r(P1,P2,P3,P4,P5)> { DEF(5, (P1,P2,P3,P4,P5)); typedef typelist<P1,P2,P3,P4,P5> P; };
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6> struct function<r(P1,P2,P3,P4,P5,P6)> { DEF(6, (P1,P2,P3,P4,P5,P6)); typedef typelist<P1,P2,P3,P4,P5,P6> P; };
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7> struct function<r(P1,P2,P3,P4,P5,P6,P7)> { DEF(7, (P1,P2,P3,P4,P5,P6,P7)); typedef typelist<P1,P2,P3,P4,P5,P6,P7> P; };
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8> struct function<r(P1,P2,P3,P4,P5,P6,P7,P8)> { DEF(8, (P1,P2,P3,P4,P5,P6,P7,P8)); typedef typelist<P1,P2,P3,P4,P5,P6,P7,P8> P; };
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9> struct function<r(P1,P2,P3,P4,P5,P6,P7,P8,P9)> { DEF(9, (P1,P2,P3,P4,P5,P6,P7,P8,P9)); typedef typelist<P1,P2,P3,P4,P5,P6,P7,P8,P9> P; };
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10> struct function<r(P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)> { DEF(10, (P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)); typedef typelist<P1,P2,P3,P4,P5,P6,P7,P8,P9,P10> P; };
#undef DEF

// types of member functions
#define DEF(n,P)	enum {N = n}; typedef t T; typedef r R; typedef R (t::*F)P; F f
template<class t, typename r> struct function<r(t::*)(void)> { DEF(0, (void)); typedef typelist<> P; };
template<class t, typename r, typename P1> struct function<r(t::*)(P1)> { DEF(1, (P1)); typedef typelist<P1> P; };
template<class t, typename r, typename P1, typename P2> struct function<r(t::*)(P1,P2)> { DEF(2, (P1,P2)); typedef typelist<P1,P2> P; };
template<class t, typename r, typename P1, typename P2, typename P3> struct function<r(t::*)(P1,P2,P3)> { DEF(3, (P1,P2, P3)); typedef typelist<P1,P2,P3> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4> struct function<r(t::*)(P1,P2,P3,P4)> { DEF(4, (P1,P2,P3,P4)); typedef typelist<P1,P2,P3,P4> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5> struct function<r(t::*)(P1,P2,P3,P4,P5)> { DEF(5, (P1,P2,P3,P4,P5)); typedef typelist<P1,P2,P3,P4,P5> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6> struct function<r(t::*)(P1,P2,P3,P4,P5,P6)> { DEF(6, (P1,P2,P3,P4,P5,P6)); typedef typelist<P1,P2,P3,P4,P5,P6> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7> struct function<r(t::*)(P1,P2,P3,P4,P5,P6,P7)> { DEF(7, (P1,P2,P3,P4,P5,P6,P7)); typedef typelist<P1,P2,P3,P4,P5,P6,P7> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8> struct function<r(t::*)(P1,P2,P3,P4,P5,P6,P7,P8)> { DEF(8, (P1,P2,P3,P4,P5,P6,P7,P8)); typedef typelist<P1,P2,P3,P4,P5,P6,P7,P8> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9> struct function<r(t::*)(P1,P2,P3,P4,P5,P6,P7,P8,P9)> { DEF(9, (P1,P2,P3,P4,P5,P6,P7,P8,P9)); typedef typelist<P1,P2,P3,P4,P5,P6,P7,P8,P9> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10> struct function<r(t::*)(P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)> { DEF(10, (P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)); typedef typelist<P1,P2,P3,P4,P5,P6,P7,P8,P9,P10> P; };

template<class t, typename r> struct function<r(t::*)(void) const> { DEF(0, (void)); typedef typelist<> P; };
template<class t, typename r, typename P1> struct function<r(t::*)(P1) const> { DEF(1, (P1)); typedef typelist<P1> P; };
template<class t, typename r, typename P1, typename P2> struct function<r(t::*)(P1,P2) const> { DEF(2, (P1,P2)); typedef typelist<P1,P2> P; };
template<class t, typename r, typename P1, typename P2, typename P3> struct function<r(t::*)(P1,P2,P3) const> { DEF(3, (P1,P2, P3)); typedef typelist<P1,P2,P3> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4> struct function<r(t::*)(P1,P2,P3,P4) const> { DEF(4, (P1,P2,P3,P4)); typedef typelist<P1,P2,P3,P4> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5> struct function<r(t::*)(P1,P2,P3,P4,P5) const> { DEF(5, (P1,P2,P3,P4,P5)); typedef typelist<P1,P2,P3,P4,P5> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6> struct function<r(t::*)(P1,P2,P3,P4,P5,P6) const> { DEF(6, (P1,P2,P3,P4,P5,P6)); typedef typelist<P1,P2,P3,P4,P5,P6> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7> struct function<r(t::*)(P1,P2,P3,P4,P5,P6,P7) const> { DEF(7, (P1,P2,P3,P4,P5,P6,P7)); typedef typelist<P1,P2,P3,P4,P5,P6,P7> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8> struct function<r(t::*)(P1,P2,P3,P4,P5,P6,P7,P8) const> { DEF(8, (P1,P2,P3,P4,P5,P6,P7,P8)); typedef typelist<P1,P2,P3,P4,P5,P6,P7,P8> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9> struct function<r(t::*)(P1,P2,P3,P4,P5,P6,P7,P8,P9) const> { DEF(9, (P1,P2,P3,P4,P5,P6,P7,P8,P9)); typedef typelist<P1,P2,P3,P4,P5,P6,P7,P8,P9> P; };
template<class t, typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10> struct function<r(t::*)(P1,P2,P3,P4,P5,P6,P7,P8,P9,P10) const> { DEF(10, (P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)); typedef typelist<P1,P2,P3,P4,P5,P6,P7,P8,P9,P10> P; };
#undef DEF


// types of functions defined by typelists
template<typename r, typename L> struct function_p;
template<typename r, typename P1> struct function_p<r, typelist<P1> > : function<r(P1)>	{};
template<typename r, typename P1, typename P2> struct function_p<r, typelist<P1,P2> > : function<r(P1,P2)> {};
template<typename r, typename P1, typename P2, typename P3> struct function_p<r, typelist<P1,P2,P3> > : function<r(P1,P2,P3)> {};
template<typename r, typename P1, typename P2, typename P3, typename P4> struct function_p<r, typelist<P1,P2,P3,P4> > : function<r(P1,P2,P3,P4)> {};
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5> struct function_p<r, typelist<P1,P2,P3,P4,P5> > : function<r(P1,P2,P3,P4,P5)> {};
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6> struct function_p<r, typelist<P1,P2,P3,P4,P5,P6> > : function<r(P1,P2,P3,P4,P5,P6)> {};
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7> struct function_p<r, typelist<P1,P2,P3,P4,P5,P6,P7> > : function<r(P1,P2,P3,P4,P5,P6,P7)> {};
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8> struct function_p<r, typelist<P1,P2,P3,P4,P5,P6,P7,P8> > : function<r(P1,P2,P3,P4,P5,P6,P7,P8)> {};
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9> struct function_p<r, typelist<P1,P2,P3,P4,P5,P6,P7,P8,P9> > : function<r(P1,P2,P3,P4,P5,P6,P7,P8,P9)> {};
template<typename r, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10> struct function_p<r, typelist<P1,P2,P3,P4,P5,P6,P7,P8,P9,P10> > : function<r(P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)> {};
...
// call a function using tuple
template<typename F,typename P> inline_only typename function<F>::R call(F f, const tuple<P> &p)		{ return call_tuple_s<0, function<F>::N>::go(f, p); }
template<int O, typename F,typename P> inline_only typename function<F>::R call(F f, const tuple<P> &p)	{ return call_tuple_s<O, function<F>::N>::go(f, p); }

// call a member function using tuple
template<class T, typename F,typename P> inline_only typename function<F>::R call(T &t, F f, const tuple<P> &p)			{ return call_tuple_s<0, function<F>::N>::go(t, f, p); }
template<class T, int O, typename F,typename P> inline_only typename function<F>::R call(T &t, F f, const tuple<P> &p)	{ return call_tuple_s<O, function<F>::N>::go(t, f, p); }
...
template<typename R, typename P1, typename... PP> struct _closure<R(P1, PP...)> {
	...
	typedef	R				return_t;
	typedef	P1				param1_t;
	typedef vallist<PP...>	params_t;
	params_t				params;

	template<function_t f, int... II> return_t call(P1 p1, index_list<II...>) const { 
...
template<typename R, typename C, typename P1, typename... PP> struct _closure<R (C::*)(P1, PP...)> {
	...
	_closure(C &_c, PP&&... pp) : c(_c), params(pp...) {}
};
...
template<typename C, typename F> struct lambda_container {
	...
	lambda_container(const C &_c, F &_f) : c(_c), f(_f) {}
	iterator	begin()	const	{ return iterator(iso::begin(c), f); }
	iterator	end()	const	{ return iterator(iso::end(c), f); }
};
...
public:
	...
	virtfunc()	: f(NULL)		{}
//	virtfunc(R (*_f)(void*, PP...)) : f(_f) {}
	template<class T>	inline_only virtfunc(T *t)		{ bind(t);	}
};
...
public:
	...
	template<class T>	inline_only callback(R (*_f)(T*, PP...), T *_me)	{ bind(_f, _me); }
...
public:
	...
	callback() : me(NULL), f(NULL)							{}
	callback(const void *_me, ftype *_f) : me(_me), f(_f)	{}
	template<class T>	inline_only callback(R (*_f)(const T*, PP...), const T *_me)	{ bind(_f, _me); }
	template<class T>	inline_only callback(const T *_me)								{ bind(_me); }
//	template<class T>	inline_only callback(const T &_me)								{ bind(&_me); }
};
...
template<typename C, typename R, typename...PP> struct function_tocallback<R(C*,PP...)> {
	typedef callback<R(PP...)> type;
};
...
public:
	...
	operator safe_bool::type()	const	{ return safe_bool::test(me);}
};
